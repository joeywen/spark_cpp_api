...
class SparkContext(
   ...
   * @param jobName A name for your job, to display on the cluter web UI
   *
   * modified By wen zhiguang 2012-12-14
   *
   */
  def this(master: String, jobName: String = ("job" + JString.valueOf(System.currentTimeMillis))) = this(master, jobName, null, Nil, Map())
